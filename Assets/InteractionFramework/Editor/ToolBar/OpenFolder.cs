...
namespace InteractionFramework.Editor
{
    ...
    public static class OpenFolder
    {
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem("Interaction Framework/Open Folder/Data Path", false, 10)]
        ...
        /// </summary>
        [MenuItem("Interaction Framework/Open Folder/Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem("Interaction Framework/Open Folder/Streaming Assets Path", false, 12)]
        ...
        /// </summary>
        [MenuItem("Interaction Framework/Open Folder/Temporary Cache Path", false, 13)]
        ...
        public static void Execute(string folder)
        {
            ...
            switch (Application.platform)
            {
                ...
                default:
                    throw new System.Exception("No Folder");
            }
        }
    }
}
