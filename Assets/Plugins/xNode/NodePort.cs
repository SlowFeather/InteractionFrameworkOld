...
namespace XNode {
    ...
    public class NodePort {
        ...
        /// <summary> Return the first non-null connection 返回第一个非空连接 </summary>
        ...
        /// <summary> Is this port connected to anytihng? 这个端口连接到anytihng吗？ </summary>
        ...
        /// <summary> Construct a static targetless nodeport. Used as a template.构造一个静态无目标节点端口。用作模板 </summary>
        ...
        /// <summary> Copy a nodePort but assign it to another node.复制节点端口，但将其分配给另一个节点 </summary>
